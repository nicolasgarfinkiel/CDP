<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="Index.aspx.cs" Inherits="CartaDePorte.Web.Index" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function isNumberKeyHumedad(evt) {
            var charCode = (evt.which) ? evt.which : evt.keyCode;

            <%--switch (document.getElementById("<%=txtPHumedad.ClientID %>").value.length) {
                case 1:
                    document.getElementById("<%=txtPHumedad.ClientID %>").value = "0.0" + text.value;
                    break;
                default:
                    var data = document.getElementById("<%=txtPHumedad.ClientID %>").value.replace(".", "");
                    var first = data.substring(0, (data.length - 1));
                    var second = data.substring(data.length - 1);
        ...
        --%>
            ...
            if (charCode != 44)
                if ((document.getElementById('ctl00_ContentPlaceHolder1_txtPHumedad').value + String.fromCharCode(charCode)) > 100)
                    return false;

            if (charCode > 31 && (charCode < 48 || charCode > 57) && charCode != 44)
                return false;

            //document.getElementById("<%=txtPHumedad.ClientID %>").value = temp;

            return true;
        }

        function isNumberKeyOtros(evt) {
            var charCode = (evt.which) ? evt.which : evt.keyCode;

            <%--  switch (document.getElementById("<%=txtPOtros.ClientID %>").value.length) {
                case 1:
                    document.getElementById("<%=txtPOtros.ClientID %>").value = "0.0" + text.value;
                    break;
                default:
                    var data = document.getElementById("<%=txtPOtros.ClientID %>").value.replace(".", "");
                    var first = data.substring(0, (data.length - 1));
                    var second = data.substring(data.length - 1);
                    var temp = Math.abs(first) + "." + second;
            }
            ...
            if (charCode != 44)
                if ((document.getElementById('ctl00_ContentPlaceHolder1_txtPOtros').value + String.fromCharCode(charCode)) > 100)
                    return false;

            if (charCode > 31 && (charCode < 48 || charCode > 57) && charCode != 44)
                return false;

            //document.getElementById("<%=txtPOtros.ClientID %>").value = temp;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            ...
            <td style="font-family: Arial, Helvetica, sans-serif; font-size: large" class="style75">
                <table align="right">
                    <tr>
                        <td>
                            <asp:Button ID="btnImprimir" runat="server" Text="Imprimir" Width="110px" Visible="false"
                                OnClick="btnImprimir_Click" OnClientClick="aspnetForm.target ='_new';" />
                        </td>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelConfirmarArribo" UpdateMode="Conditional" runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="btnConfirmarArribo" runat="server" Text="Confirmar Arribo" Width="110px"
                                        OnClientClick="return ValidarConfirmarArribo()" Visible="false" OnClick="btnConfirmarArribo_Click" />
                                    <asp:UpdateProgress ID="UpdateProgressConfirmarArribo" runat="server" AssociatedUpdatePanelID="UpdatePanelConfirmarArribo">
                                        <ProgressTemplate>
                        ...
                        <td>
                            <asp:UpdatePanel ID="savepanelAnular" UpdateMode="Conditional" runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="btnAnular" runat="server" Text="Anular" Width="110px" OnClick="btnAnular_Click"
                                        OnClientClick="return ValidarAnular()" Visible="false" />
                                    <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="savepanelAnular">
                                        <ProgressTemplate>
                                            <div style="position: fixed; top: 0px; bottom: 0px; left: 0px; right: 0px; overflow: hidden; padding: 0; margin: 0; background-color: #000000; filter: alpha(opacity=50); opacity: 0.5; z-index: 100000;">
                                            </div>
                                            <div style="position: fixed; top: 40%; left: 40%; height: 20%; width: 20%; z-index: 100001; background-color: #FFFFFF; border: 2px solid #000000; background-image: url('Content/Images/ajax_loader_large.gif'); background-size: 32px 32px; background-repeat: no-repeat; background-position: center;">
                        ...
                        <td>
                            <asp:Button ID="btnModelo" runat="server" Text="Modelo" Width="110px" OnClick="btnModelo_Click"
                                Visible="false" />
                        </td>
                        <td>
                            <asp:Button ID="btnNueva" runat="server" Text="Nueva" Width="110px" OnClick="btnNueva_Click"
                                Visible="false" />
                        </td>
                    </tr>
                </table>
    ...
    <table class="tabla1">
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:DropDownList ID="cboTipoDeCarta" runat="server" Height="21px" Style="margin-left: 0px"
                    Width="300px" OnSelectedIndexChanged="cboTipoDeCarta_SelectedIndexChanged" AutoPostBack="true">
                </asp:DropDownList>
            </td>
            <%--<td colspan="2">
                &nbsp;
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="cboTipoDeCarta" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
            <td>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label ID="lblFechaVencimiento" runat="server" Text="Fecha De Vencimiento" Visible="false"></asp:Label>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="cboTipoDeCarta" EventName="SelectedIndexChanged" />
                    </Triggers>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:TextBox ID="txtFechaVencimiento" runat="server" Width="80" Visible="false"></asp:TextBox>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="cboTipoDeCarta" EventName="SelectedIndexChanged" />
                    </Triggers>
        ...
        <tr>
            ...
            <td align="left" style="margin-left: 200px">
                <asp:UpdatePanel ID="UpdatePanetxtCtgManual" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label ID="txtCtg" runat="server" Width="149px" CssClass="LabelBuscadorResul"></asp:Label>
                        <asp:TextBox ID="txtCtgManual" runat="server" Width="150px" Visible="false"></asp:TextBox>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="cboTipoDeCarta" EventName="SelectedIndexChanged" />
                    </Triggers>
            ...
            <td align="center">
                <asp:UpdatePanel ID="UpdatePaneLNumeroCDP" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label ID="txtNumeroCDP" runat="server" Width="149px" CssClass="LabelBuscadorResul"></asp:Label>
                        <asp:TextBox ID="txtNumeroCDPManual" runat="server" Width="100px" Visible="false"></asp:TextBox>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="cboTipoDeCarta" EventName="SelectedIndexChanged" />
                    </Triggers>
            ...
            <td align="center">
                <asp:UpdatePanel ID="UpdatePanelNumeroCEE" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label ID="txtNumeroCEE" runat="server" Width="149px" CssClass="LabelBuscadorResul"></asp:Label>
                        <asp:TextBox ID="txtNumeroCEEManual" runat="server" Width="100px" Visible="false"></asp:TextBox>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="cboTipoDeCarta" EventName="SelectedIndexChanged" />
                    </Triggers>
    ...
    <table align="center" class="tabla1" id="tableCarga2" runat="server" visible="true">
        ...
        <tr>
            <td class="style35">
                ...
                <%--<asp:RadioButton ID="rbConforme" runat="server" Text="Conforme" />--%>
            </td>
            <td class="style73">
        ...
        <tr>
            ...
            <td rowspan="2">
                <table align="left" id="tbPorcentajes" runat="server" visible="false">
                    <tr>
                        <td>
                            <asp:Label ID="lblPHumedad" runat="server" Text="% Humedad"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtPHumedad" onkeypress="return isNumberKeyHumedad(event)" MaxLength="6" Text="" runat="server" Width="80px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="lblPOtros" runat="server" Text="% Otros"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtPOtros" MaxLength="6" onkeypress="return isNumberKeyOtros(event)" Text="" runat="server" Width="80px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table align="center" class="tabla1" id="tableCarga5" runat="server" visible="true">
            ...
            <td>
                ...
                <asp:UpdatePanel ID="UpdatePanel10" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:HiddenField ID="hbClientePagadorDefaultId" runat="server" />
                        <asp:HiddenField ID="hbClientePagadorDefaultName" runat="server" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:RadioButtonList ID="rblFletePagadoAPagar" runat="server" Height="20px" RepeatDirection="Horizontal"
                    Width="319px">
        ...
        <tr>
            ...
            <td class="style74">
                <asp:TextBox ID="txtTarifaReferencia" runat="server" Width="200px" Enabled="false"></asp:TextBox>
            </td>
            <td>&nbsp;
            </td>
            <td class="style52">&nbsp;
    ...
    <table class="style1">
            ...
            <td class="style58">
                <asp:UpdatePanel ID="UpdatePanel9" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="btnGuardarCambio" EventName="Click" />
        ...
        <tr>
            <td class="style58" align="right">
                ...
                <asp:UpdatePanel ID="savepanelCambio" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btnGuardarCambio" runat="server" Text="Guardar Cambio Desvio" Visible="false"
                            OnClick="btnGuardarCambio_Click" OnClientClick="return ValidarGuardarCambioDesvio()"
                            Width="221px" />
                        <asp:UpdateProgress ID="UpdateProgressCambio" runat="server" AssociatedUpdatePanelID="savepanelCambio">
                            <ProgressTemplate>
                                <div style="position: fixed; top: 0px; bottom: 0px; left: 0px; right: 0px; overflow: hidden; padding: 0; margin: 0; background-color: #000000; filter: alpha(opacity=50); opacity: 0.5; z-index: 100000;">
                                </div>
                                <div style="position: fixed; top: 40%; left: 40%; height: 20%; width: 20%; z-index: 100001; background-color: #FFFFFF; border: 2px solid #000000; background-image: url('Content/Images/ajax_loader_large.gif'); background-size: 32px 32px; background-repeat: no-repeat; background-position: center;">
                                    <center>
                                        ...
                                        Solicitando
                                        <br />
                                        Cambio de Destino en AFIP</center>
                                </div>
                            </ProgressTemplate>
                        </asp:UpdateProgress>
                    </ContentTemplate>
                ...
                <asp:UpdatePanel ID="savepanel" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:Button ID="btnGuardar" runat="server" Text="Guardar y Enviar" OnClick="btnGuardar_Click" />
                            </ContentTemplate>
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="cboTipoDeCarta" EventName="SelectedIndexChanged" />
                            </Triggers>
    ...
    <div class="Buscadores" id="BuscadorEmpresa" runat="server">
        <table style="width: 599px; height: 50px">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnBuscadorEmpresa" runat="server" Text="Buscar" OnClick="btnBuscadorEmpresa_Click"></asp:Button>
                </td>
                <td class="style60">
                    <asp:Button ID="btnCerrarEmpresa" runat="server" Text="Cerrar" OnClick="btnCerrarEmpresa_Click"></asp:Button>
                </td>
            </tr>
            <tr>
                <td colspan="3">
    ...
    <div class="Buscadores" id="BuscadorCliente" runat="server">
        <table style="width: 599px; height: 50px">
            ...
            <tr>
                <td>&nbsp;&nbsp;
                            <asp:TextBox ID="txtBuscadorCliente" placeholder="BUSCAR" runat="server" Width="300px"></asp:TextBox>
                </td>
                <td>
                    <asp:Button ID="btnBuscadorCliente" runat="server" Text="Buscar" OnClick="btnBuscadorCliente_Click"></asp:Button>
                </td>
                <td>
                    <asp:Button ID="btnCerrarCliente" runat="server" Text="Cerrar" OnClick="btnCerrarCliente_Click"></asp:Button>
                </td>
            </tr>
            <tr>
                <td colspan="3">&nbsp;&nbsp; Alta Cliente Prospecto
                </td>
            </tr>
            <tr>
                <td>&nbsp;
                            <asp:TextBox ID="txtClienteAltaRapidaNombre" runat="server"
                                placeholder="NOMBRE" Width="150px"></asp:TextBox>
                </td>
                <td>&nbsp;
                            <asp:TextBox ID="txtClienteAltaRapidaCuit" runat="server" placeholder="CUIT"
                                Width="100px"></asp:TextBox>
                </td>
                <td>
                    <div id="divClienteAltaRapida" runat="server">
                        <asp:Button ID="btnCargaRapidaCliente" runat="server"
                            OnClick="btnCargaRapidaCliente_Click" Text="Alta Prospecto"></asp:Button>
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <div class="Buscadores" id="BuscadorProveedor" runat="server">
        <table style="width: 599px; height: 50px">
            <tr>
                <td colspan="3">
                    <br />
                    <asp:Label ID="Label13" runat="server" Text="BUSCADOR DE PROVEEDORES" CssClass="SubTitulos"></asp:Label>
                    <br />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:Button ID="btnBuscadorProveedor" runat="server" Text="Buscar" OnClick="btnBuscadorProveedor_Click"></asp:Button>
                </td>
                <td>
                    <asp:Button ID="btnCerrarProveedor" runat="server" Text="Cerrar" OnClick="btnCerrarProveedor_Click"></asp:Button>
                </td>
                <td>&nbsp;
                </td>
            </tr>
            ...
            <tr>
                <td>&nbsp;
							<asp:TextBox ID="txtProveedorAltaRapidaNombre" runat="server"
                                placeholder="NOMBRE" Width="150px"></asp:TextBox>
                </td>
                <td>&nbsp;
							<asp:TextBox ID="txtProveedorAltaRapidaCuit" runat="server" placeholder="CUIT"
                                Width="100px"></asp:TextBox>
                </td>
                <td>
                    <div id="div2" runat="server">
                        <asp:Button ID="btnCargaRapidaProveedor" runat="server"
                            OnClick="btnCargaRapidaProveedor_Click" Text="Alta Prospecto"></asp:Button>
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <div class="BuscadoresChofer" id="BuscadorChofer" runat="server">
        <table style="width: 700px; height: 50px">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtChoferAltaRapidaNombre" runat="server" placeholder="NOMBRE"
                        Width="150px"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtChoferAltaRapidaApellido" runat="server" placeholder="APELLIDO" Width="150px"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtChoferAltaRapidaCuit" runat="server" placeholder="CUIT"
                        Width="100px"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtChoferAltaRapidaCamion" runat="server" placeholder="CAMION"
                        Width="80px"></asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtChoferAltaRapidaAcoplado" runat="server" placeholder="ACOPLADO" Width="80px"></asp:TextBox>
                </td>
                <td>
                    <div id="divChoferAltaRapida" runat="server">
                        <asp:Button ID="btnCargaRapidaChofer" runat="server"
                            OnClick="btnCargaRapidaChofer_Click" Text="Alta Rapida" />
                    </div>
                </td>
            </tr>
            <tr>
    ...
    <div id="divServiceUnavailable" runat="server" visible="false">
        ...
        <div id="div1" runat="server">
            <asp:Button ID="btnCerrarServiceUnavailable" runat="server" Text="Aceptar" OnClick="btnCerrarServiceUnavailable_Click" />
        </div>
    </div>
