<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CPE.aspx.cs" Inherits="CartaDePorte.Web.CPE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label3" runat="server" Text="Cartas de Porte Emitidas" CssClass="TituloReporte"></asp:Label>
    <br />
    <br />
    <table class="style1">
        <tr>
