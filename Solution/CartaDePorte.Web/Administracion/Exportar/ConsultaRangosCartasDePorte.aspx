<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ConsultaRangosCartasDePorte.aspx.cs" Inherits="CartaDePorte.Web.ConsultaRangosCartasDePorte" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        <br />
    <asp:Label ID="Label3" runat="server" Text="Lotes de Cartas de Porte" CssClass="TituloReporte"></asp:Label>
    <br />
    <br />
    <table class="style1">
        <tr>
