<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="contingencias.aspx.cs" Inherits="CartaDePorte.Web.contingencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <asp:UpdateProgress ID="UpdateProgressConfirmarArribo" runat="server" AssociatedUpdatePanelID="UpdatePanelConfirmarArribo">
                                        <ProgressTemplate>
                                            <div style="position: fixed; top: 0px; bottom: 0px; left: 0px; right: 0px; overflow: hidden;
                                                padding: 0; margin: 0; background-color: #000000; filter: alpha(opacity=50);
                                                opacity: 0.5; z-index: 100000;">
                                            </div>
                                            <div style="position: fixed; top: 40%; left: 40%; height: 20%; width: 20%; z-index: 100001;
                                                background-color: #FFFFFF; border: 2px solid #000000; background-image: url('Content/Images/ajax_loader_large.gif');
    ...
    <br />
    <br />
    <div id="divAdminFull" runat="server" style="z-index: 10000;">
        <table class="tabla1" id="tableCarga1" runat="server" visible="true">
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteTitularCartaPorte" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteIntermediario" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteRemitenteComercial" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteCorredor" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteRepresentanteEntregador" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteDestinatario" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteDestino" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteTransportista" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeleteChofer" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
        ...
        <table align="center" class="tabla1" id="tableCarga2" runat="server" visible="true">
            ...
            <tr>
                ...
                <td rowspan="2">&nbsp;
                    <%--<asp:RadioButton ID="rbCondicional" runat="server" Text="Condicional" />--%>
                    &nbsp; &nbsp; &nbsp;
                </td>
                <td class="style73">
        ...
        <table align="center" class="tabla1" id="tableCarga5" runat="server" visible="true">
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonDeletePagadorFlete" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
                ...
                <td class="style42" colspan="3">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:ImageButton ID="ImageButtonDeleteDestinatarioCambio" runat="server" ImageUrl="~/Content/Images/icon_Delete.png"
                        ...
                        <td colspan="3">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtChoferAltaRapidaApellido" placeholder="APELLIDO" runat="server" Width="150px"></asp:TextBox>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtChoferAltaRapidaAcoplado" placeholder="ACOPLADO" runat="server" Width="80px"></asp:TextBox>
                                    </td>
                                    <td>
