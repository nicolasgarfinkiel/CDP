<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="BandejaDeSalida.aspx.cs" Inherits="CartaDePorte.Web.BandejaDeSalida" %>
    ...
    <asp:UpdatePanel ID="upTblData" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <table style="width: 929px">
                <tr>
                    <td class="style10">
                        <asp:Label ID="Label3" runat="server" Text="Búsqueda de Carta de Porte" CssClass="TituloReporte"></asp:Label>
                    </td>
            ...
            <table class="tabla1">
                <tr>
                    <td class="style6">
                        <asp:Label ID="lblBusqueda" runat="server" Text="CDP/CTG/Usuario/Establecimiento Origen"></asp:Label>
                    </td>
                    <td class="style3">
