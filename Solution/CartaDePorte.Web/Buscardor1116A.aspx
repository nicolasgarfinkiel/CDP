<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="Buscardor1116A.aspx.cs" Inherits="CartaDePorte.Web.Buscardor1116A" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upTblData" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <table style="width: 929px">
                <tr>
                    <td class="style10">
                        <asp:Label ID="Label3" runat="server" Text="Búsqueda Formularios 1116A" CssClass="TituloReporte"></asp:Label>
                    </td>
                    <td class="styleLink" align="right">
                        <asp:Button ID="btnNueva" runat="server"
                            Text="Nuevo" Width="78px" OnClick="btnNueva_Click" />
                    </td>
                </tr>
            </table>
            <br />
            ...
            <table class="tabla1">
                <tr>
                    <td class="style6">
                        <asp:Label ID="Label2" runat="server" Text="CDP / Nro.Formulario"></asp:Label>
                    </td>
                    <td class="style3">
    ...
    <br />
    <asp:Button ID="btnCargarMas" runat="server" Text="Ver mas Formularios" OnClick="btnCargarMas_Click" />
    <br />
</asp:Content>
